...
db = PostgresqlDatabase('movie', user='elisa', password='718640', host='localhost', port=5000)
...
Movie(name='Spider-Man Into the Spider verse', genre='Action/Sci-fi', year=2018).save()
